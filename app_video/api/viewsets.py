...
class VideoViewSet(viewsets.ModelViewSet):
    ...
    def create(self, request, *args, **kwargs):
        ...
        if serializer.is_valid():
            serializer.save()
            return Response(
                {"detail": "Video Incluido com Sucesso!", "video": serializer.data},
    ...
    def update(self, request, *args, **kwargs):
        try:
            ...
            return Response(
                {"detail": "Video Editado com sucesso!.", "data": serializer.data},
                status=status.HTTP_200_OK,
            )
        except Http404:
            return Response(
                {"detail": "Video não encontrado."}, status=status.HTTP_404_NOT_FOUND
            )
    ...
    def destroy(self, request, *args, **kwargs):
        try:
            ...
            return Response(
                {"detail": "Video deletado com sucesso!."}, status=status.HTTP_200_OK
            )
        except Http404:
            return Response(
                {"detail": "Video não encontrado."}, status=status.HTTP_404_NOT_FOUND
